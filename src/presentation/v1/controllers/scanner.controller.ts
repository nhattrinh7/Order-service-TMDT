...
export class ScannerController {
  ...
  async getScannerWarehouse(@Param('scannerId', ParseUUIDPipe) scannerId: string) {
    const result = await this.queryBus.execute(new GetScannerWarehouseQuery(scannerId))
